...
//  Netflix Clone
//
//  Created by Aigerim Abitayeva on 21.03.2023.
//
...
class CollectionViewTableViewCell: UITableViewCell {
    ...
    public func configure(with titles: [Title]) {
        ...
        // we have retrieved the titles earlier and updated the titles array
        // therefore, we need to reload the data for the collectionView inside the main thread, that's what DispatchQueue does
    }
